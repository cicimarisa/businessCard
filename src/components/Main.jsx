        ...
        <main>
            <div className="container">
                ...
                <div className="description">
                    <h3>About Me</h3>
                    <p>I am a frontend developer who have been in IT industry for around 5 years and worked in variety of technologies.
                    ...
                    <h3>Interest</h3>
                    <p>I enjoy swimming, traveling, and photography. An open minded person that likes spicy food.</p>
                </div>
            </div>
